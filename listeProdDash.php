                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        Voici votre panneau de configuration de <span class="fw-bold">Apple Tunisie
                                            .</span> Vous pouvez ici consulter les différentes commandes , les produits
                                        disponibles , les modifiers ou les supprimers.
                                    </p>
...
?>
            ...
            <div class="modal fade" id="editArticleDialog" tabindex="-1" role="dialog"
                aria-labelledby="editArticleDialogLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editArticleForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editArticleName" name="name" value=""
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="editArticlePrice">Prix de l'article</label>
                                    <input type="number" class="form-control" id="editArticlePrice" name="price"
                                        value="" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="saveChangesBtn">Enregistrer les
