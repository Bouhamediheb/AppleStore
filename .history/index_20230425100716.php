...
<body>
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="nav navbar-nav flex-grow-1 justify-content-between">
          ...
          <?php if (isset($_SESSION['user_id'])): ?>
            <!-- if user logged in, show Name and logout icon -->
          ...
          <?php else: ?>
            <!-- if user not logged in, show login and register icon -->
  ...
  <!-- Bootstrap only  Big image in the center -->
  ...
  <div class="container-fluid bg-white text-light py-5 text-center">
    <div class="row">
      ...
      <div class="row">
        ...
        <!-- Bootstrap black container with Text iphone 12 , and image from folder image below -->
        <div class="container-fluid bg-dark text-light py-5 text-center" style="background-color:black !important;">
          <div class="row">
            <div class="col-md-6 mx-auto">
              ...
              <!-- Add learn more text blue font linked without border -->
              <a href="index.php" class="btn btn-lg ">Voir en détail</a>
              <!-- Add buy text linked -->
              <a href="index.php" class="btn btn-lg">Acheter</a>
        ...
        <div class="container center_prod">
          <div class="row center_prod">
            <?php
            // Establish database connection and retrieve product data
            $conn = mysqli_connect("localhost", "root", "root", "DataBaseProjetWeb");
            $sql = "SELECT * FROM Products";
            $result = mysqli_query($conn, $sql);

            // Loop through products and create product box for each
